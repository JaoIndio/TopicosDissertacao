...
def optimise_SVR_cv(X, y, n_comp):
  ...
  \t\tC R2:            ",AllData[4],"\n\
  \t\tepsilon R2:      ",AllData[5],"\n\
  \t\tC RPD:           ",AllData[6],"\n\
  \t\tepsilon RPD:     ",AllData[7],"\n\
  \t\tVariancia:       ",AllData[8],"\n\
        ...
        for i in pca_control:
          ...
          if rpd>max_rpd:
            ...
            with open(bestFit_file, 'a') as file:
              data=(f"max_rpd,max_r2,R2_rdn,RPD_rdn,C_R2,epsilon_R2,C_RPD,epsilon_RPD,PCA Variancia,random_numbers\n\
              {max_rpd},{max_r2},\
              {best_randomR2},{best_randomRpd},\
              {C_BestR2},{epislon_BestR2},\
              {C_BestRPD},{epislon_BestRPD},{varia},\
              {random_num}\n\
              ==============================================================\n\n")
              file.write(data)
              file.close()

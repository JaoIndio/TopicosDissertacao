...
def optimise_DecisionTree_cv(X, y, n_comp):
  ...
  splitter_BestR2,
  max_depth_BestR2,
  min_samples_split_BestR2,
	min_samples_leaf_BestR2,
	features_BestR2,
	min_weight_fraction_leaf_BestR2,
	max_leaf_nodes_BestR2,
	
  criterio_BestRPD,
	splitter_BestRPD,
	max_depth_BestRPD,
	min_samples_split_BestRPD,
	min_samples_leaf_BestRPD,
	features_BestRPD,
	min_weight_fraction_leaf_BestRPD,
	max_leaf_nodes_BestRPD,
	random_num
  ...
  # Configuracao do Melhor Resultado ate o momento. Atingido dia 11/11/23 na WorSation DELL
  crit= 		      1 
  split=          1
  m_depth=  	    1
  min_samp_split= 0
              ...
              while weight < len(min_weight_fraction_leaf):
                ...
                while leafNode < len(max_leaf_nodes):        
                  while split < len(splitter):
                    ...
                    DT_model = DecisionTreeRegressor(criterion=criterior[crit], \
                                                     splitter=splitter[split], \
                                                     max_depth=max_depth[m_depth], \
                                                     min_samples_split=min_samples_split[min_samp_split],\
                                                     min_samples_leaf=min_samples_leaf[samp_splitLeaf], \
                                                     min_weight_fraction_leaf=min_weight_fraction_leaf[weight],\
                                                     max_features=features[feat],\
                                                     max_leaf_nodes=max_leaf_nodes[leafNode], \
                                                     random_state=10)
 ...
 *****  ***********************************\n\n")
      ...
      print("**... Dcision Tree MIR Criterion-> ", crit)
    ...
    #Crit
    crit=0
    print("**... Dcision Tree MIR Random-> ", random_num)
    random_num+=1

...
# flake8: noqa
    ...
    def draw(self,
        ...
        plt.colorbar(shrink=0.5, label="Custom. Eu add na biblioteca essa barra!" )
    ...
    def __draw_intensity__(self,
        ...
        #print("\t\t\t\t[draw intensity] tight_layout")
        plt.tight_layout()

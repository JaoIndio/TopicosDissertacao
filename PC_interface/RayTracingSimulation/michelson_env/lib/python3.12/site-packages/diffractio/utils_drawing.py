...
def draw2D(
    ...
    #print("\t\t\t\t[draw 2D] plt figure")
    id_fig = plt.figure()

    #print("\t\t\t\t[draw 2D] add_subplot")
    IDax = id_fig.add_subplot(111)
    

    #print("\t\t\t\t[draw 2D] range_scale")
    if range_scale == "um":

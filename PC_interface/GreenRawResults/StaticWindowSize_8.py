...
def set_manual_window(event):
    ...
    try:
        ...
        print("set_manual_window: manual_window_center ", manual_window_center)
        print("set_manual_window: xmin ", selected_start)
        print("set_manual_window: xmax ", selected_end)
...
def run_fft(event):
    ...
    global data_values, fft_cache, window_size, manual_window_center
...
def reset(event):
    ...
    global selected_rect, selected_start, selected_end, selection_text, data_values, fft_cache, blit_cache, manual_window_center
